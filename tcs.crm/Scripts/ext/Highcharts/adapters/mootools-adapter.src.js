...
var win = window,
	doc = document,
	mooVersion = win.MooTools.version.substring(0, 3), // GetByAccountId the first three characters of the version number
...
win.HighchartsAdapter = {
	...
	/**
	 * GetByAccountId the offset of an element relative to the top left corner of the web page
	 */
	offset: function (el) {
