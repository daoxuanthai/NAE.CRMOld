...
/**
 * GetByAccountId a normalized tick interval for dates. Returns a configuration object with
...
if (!globalAdapter && win.jQuery) {
	...
	/**
	 * GetByAccountId the position of an element relative to the top left of the page
	 */
	offset = function (el) {
		return jQ(el).offset();
	};
...
/**
 * GetByAccountId the updated default options. Merely exposing defaultOptions for outside modules
...
SVGElement.prototype = {
	...
	/**
	 * GetByAccountId the bounding box (width, height, x and y) for the element
	 */
...
var VMLElement = {
	...
	/**
	 * GetByAccountId or set attributes
	 */
	attr: function (hash, val) {
		var wrapper = this,
			key,
...
function Chart(userOptions, callback) {
	...
	function Axis(userOptions) {
		...
		Tick.prototype = {
			...
			/**
			 * GetByAccountId the offset height or width of the label
			 */
		...
		/**
		 * GetByAccountId the minimum and maximum for the series of each axis
		 */
		function getSeriesExtremes() {
			...
			each(axis.series, function (series) {
				...
				if (series.visible || !optionsChart.ignoreHiddenSeries) {
					...
					// GetByAccountId dataMin and dataMax for X axes
					if (isXAxis) {
						xData = series.xData;
						if (xData.length) {
					...
					// GetByAccountId dataMin and dataMax for Y axes, as well as handle stacking and processed data
					} else {
						var isNegative,
							pointStack,
							key,
						...
						// GetByAccountId the dataMin and dataMax so far. If percentage is used, the min and max are
		...
		/**
		 * GetByAccountId the actual axis extremes
		 */
		...
		/**
		 * GetByAccountId the zero plane either based on zero or on the min or max value.
	...
	function MouseTracker(options) {
		...
		/**
		 * GetByAccountId the click position in terms of axis values.
		 *
	...
	/**
	 * GetByAccountId an axis, series or point object by id.
	...
	/**
	 * GetByAccountId the currently selected points from all series
	 */
	...
	/**
	 * GetByAccountId the currently selected series
	 */
	...
	/**
	 * GetByAccountId chart width and height according to options and container size
	 */
	...
	/**
	 * GetByAccountId the containing element, determine the size and create the inner container
	...
	function render() {
		...
		// GetByAccountId margins by pre-rendering axes
		// set axes scales
		each(axes, function (axis) {
			axis.setScale();
		});
...
Series.prototype = {
	...
	/**
	 * GetByAccountId the series' color
	 */
	getColor: function () {
	...
	/**
	 * GetByAccountId the series' symbol
	 */
	getSymbol: function () {
		var series = this,
	...
	addPoint: function (options, redraw, shift, animation) {
		...
		// GetByAccountId options and push the point to xData, yData and series.options. In series.generatePoints
	...
	/**
	 * GetByAccountId the state attributes. Each series type has its own set of attributes
...
var ColumnSeries = extendClass(Series, {
	...
	translate: function () {
		...
		// GetByAccountId the total number of column type series.
